...
result_path = "cnu/cnu_result_mlp" # saving the processing of training phase and images ploted
num_features = 1
input_width = 168
...
class MLP_BASE(tf.keras.Model):
    def __init__(self,
        ...
        self.layer1 = layers.Dense(units=16, input_dim=input_width, activation='relu')
